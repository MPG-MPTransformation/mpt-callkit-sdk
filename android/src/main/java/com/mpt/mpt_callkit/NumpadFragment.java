...
public class NumpadFragment extends BaseFragment implements AdapterView.OnItemSelectedListener, View.OnClickListener,
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        cbConference.setChecked(Engine.Instance().mConference);
    ...
    private void handleTransfer() {
        ...
        int rt = Engine.Instance().getEngine().refer(currentLine.sessionID, referTo);
        if (rt != 0) {
    ...
    private void handleAttendTransfer() {
        ...
        int rt = Engine.Instance().getEngine().attendedRefer(currentLine.sessionID, replaceSession.sessionID, referTo);
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.zero ||
                ...
                view.getId() == R.id.four ||
                view.getId() == R.id.five ||
                view.getId() == R.id.six ||
                view.getId() == R.id.seven ||
